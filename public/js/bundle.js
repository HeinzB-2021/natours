...
var displayMap = function displayMap(loc) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGVpbnpiIiwiYSI6ImNsMWdjaDZuMTAxdGgzb2xuMWtvNWR3ZzEifQ.H8jjf_06mZCTw0nY9efJMw';
  ...
  loc.forEach(function (locs) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(locs.coordinates).addTo(map); // Add popup

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(locs.coordinates).setHTML("<p>Day ".concat(locs.day, ": ").concat(locs.description, "</p>")).addTo(map); // Extend map bounds to include current location
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'login erfolgreich') {
              (0, _alert.showAlert)('success', 'Erfolgreich eingeloggt');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Fehler bein Ausloggen. Versuchen Sie es nochmals ');
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'erfolgreiches Update') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " Erfolgreich upgedated"));
            }
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51KmG2QC90PvuAjkPkuwXjWm3WBtqfrlLQ7mJoxi1BwYJLuFtgSmXJInbdhoKPhZjDwwtMubcJlMLjYfm9gBcYFYy00nfA716W2');
            _context.prev = 1;
            _context.next = 4;
          ...
          case 9:
            ...
            (0, _alert.showAlert)('error', 'Booking hat nicht geklappt');
...
var logOutBt = document.querySelector('.nav__el--logout');
var bookBt = document.getElementById('book-tour');

if (mapBox) {
  var loc = JSON.parse(mapBox.dataset.locations);
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var orgPassword, newPassword, newPasswordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              orgPassword = document.getElementById('password-current').value;
            ...
            case 8:
              document.querySelector('.btn-save-pw').textContent = 'Save passwort';
